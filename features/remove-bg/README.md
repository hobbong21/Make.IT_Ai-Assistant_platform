...
1. 이커머스 마케터가 상품 사진을 업로드
2. 시스템이 AI 배경 제거 모델 (rembg)로 처리
3. 투명 배경 PNG 파일이 다운로드 가능해짐
4. 마케터가 다양한 배경의 프로모션 이미지 제작에 활용
...
| 메서드 | 경로 | 인증 |
|--------|------|------|
| POST | /api/marketing/remove-bg | Required (JWT) |
