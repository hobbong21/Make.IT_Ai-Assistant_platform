# youtube-influence — 변경 이력

| 날짜 | 라운드 | 변경 내용 | 파일 |
|------|--------|---------|------|
| 2026-04-20 | R1 | 초기 구현 — YouTube 영향력 API 인터페이스 정의 | YoutubeInfluenceService |
| 2026-04-24 | R7 | service-detail 페이지 통합 — 10개 서비스 자유 입력 지원 | service-detail.html, service-detail.js |
| 2026-04-26 | R18a | features/ 카탈로그 데이터 보강 — manifest.json, api.md, README, changelog 작성 | features/youtube-influence/ |
