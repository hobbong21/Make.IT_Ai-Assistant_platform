...
(function initServiceWorker() {
  ...
  /**
   * Periodic sync (background sync) — optional future use
   * Requires: manifest.json background_sync permission
   */
  if ('sync' in registration) {
    // Can be triggered by: registration.sync.register('sync-notifications')
    // Listen to sync event in SW
  }
})();
